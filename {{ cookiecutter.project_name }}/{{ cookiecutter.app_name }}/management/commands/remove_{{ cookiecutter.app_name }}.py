...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        while selection.lower() not in ['y', 'n', '']:
            selection = input('This will drop all {{ cookiecutter.app_name }}-related tables. Are you sure ([y]/n)? ')
        ...
        for ss_model in apps.get_app_config('{{ cookiecutter.app_name }}').get_models():
